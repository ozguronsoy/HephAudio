...
namespace HephAudio
{
	...
	public:
		...
		std::vector<std::shared_ptr<AudioObject>> Queue(StringBuffer queueName, hephaudio_float queueDelay, const std::vector<StringBuffer>& filePaths);
		...
		void SetAOPosition(std::shared_ptr<AudioObject> audioObject, hephaudio_float position);
		hephaudio_float GetAOPosition(std::shared_ptr<AudioObject> audioObject) const;
		...
		void SetCategoryVolume(StringBuffer categoryName, hephaudio_float newVolume);
		hephaudio_float GetCategoryVolume(StringBuffer categoryName) const;
