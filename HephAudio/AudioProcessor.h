...
#pragma region Sound Effects
	public:
		...
		static void Tremolo(AudioBuffer& buffer, hephaudio_float depth, const OscillatorBase& lfo);
		static void TremoloRT(AudioBuffer& subBuffer, size_t subBufferFrameIndex, hephaudio_float depth, const OscillatorBase& lfo);
