...
#pragma region Sound Effects
	public:
		...
		static void SineWaveTremolo(AudioBuffer& buffer, HEPHAUDIO_DOUBLE depth, HEPHAUDIO_DOUBLE frequency, HEPHAUDIO_DOUBLE phase_deg);
		static void SineWaveTremoloRT(AudioBuffer& subBuffer, size_t subBufferFrameIndex, HEPHAUDIO_DOUBLE depth, HEPHAUDIO_DOUBLE frequency, HEPHAUDIO_DOUBLE phase_deg);
		static void TriangleWaveTremolo(AudioBuffer& buffer, HEPHAUDIO_DOUBLE depth, HEPHAUDIO_DOUBLE frequency, HEPHAUDIO_DOUBLE phase_deg);
		static void TriangleWaveTremoloRT(AudioBuffer& subBuffer, size_t subBufferFrameIndex, HEPHAUDIO_DOUBLE depth, HEPHAUDIO_DOUBLE frequency, HEPHAUDIO_DOUBLE phase_deg);
		...
		static void Flanger(AudioBuffer& buffer, HEPHAUDIO_DOUBLE depth, HEPHAUDIO_DOUBLE delay_ms, HEPHAUDIO_DOUBLE rate, HEPHAUDIO_DOUBLE phase_deg);
