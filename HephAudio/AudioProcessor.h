...
#pragma region Sound Effects
	public:
		...
		static void Chorus(AudioBuffer& buffer, hephaudio_float depth, hephaudio_float feedbackGain, hephaudio_float baseDelay_ms, hephaudio_float delay_ms, hephaudio_float extent_semitone, const Oscillator& lfo);
...
#pragma region Filters
	public:
		...
		static void LowPassFilterMT(AudioBuffer& buffer, hephaudio_float cutoffFreq, size_t threadCountPerChannel);
		static void LowPassFilterMT(AudioBuffer& buffer, size_t hopSize, size_t fftSize, hephaudio_float cutoffFreq, size_t threadCountPerChannel);
		...
		static void HighPassFilterMT(AudioBuffer& buffer, hephaudio_float cutoffFreq, size_t threadCountPerChannel);
		static void HighPassFilterMT(AudioBuffer& buffer, size_t hopSize, size_t fftSize, hephaudio_float cutoffFreq, size_t threadCountPerChannel);
		...
		static void BandPassFilterMT(AudioBuffer& buffer, hephaudio_float lowCutoffFreq, hephaudio_float highCutoffFreq, size_t threadCountPerChannel);
		static void BandPassFilterMT(AudioBuffer& buffer, size_t hopSize, size_t fftSize, hephaudio_float lowCutoffFreq, hephaudio_float highCutoffFreq, size_t threadCountPerChannel);
		...
		static void BandCutFilterMT(AudioBuffer& buffer, hephaudio_float lowCutoffFreq, hephaudio_float highCutoffFreq, size_t threadCountPerChannel);
		static void BandCutFilterMT(AudioBuffer& buffer, size_t hopSize, size_t fftSize, hephaudio_float lowCutoffFreq, hephaudio_float highCutoffFreq, size_t threadCountPerChannel);
