...
namespace HephAudio
{
	...
	{
		return 0.21557895 - 0.41663158 * cos(2.0 * HephMath::pi * n / this->N) + 0.277263158 * cos(4.0 * HephMath::pi * n / this->N) - 0.083578947 * cos(6.0 * HephMath::pi * n / this->N) + 0.006947368 * cos(8.0 * HephMath::pi * n / this->N);
	}
