				...
				HEPHAUDIO_CH_LAYOUT_4_POINT_0,
				{
...

					{
						...
						[](heph_audio_sample_t* in, heph_audio_sample_t* out) -> void
						{
							...
							out[1] = (in[1] * 0.875) + (in[4] * 0.125);
							out[2] = in[2];
							out[3] = (in[5] * 0.75) + (in[3] * 0.125) + (in[4] * 0.125);
						}
					},
...

					{
						...
						[](heph_audio_sample_t* in, heph_audio_sample_t* out) -> void
						{
							...
							out[1] = (in[1] * 0.875) + (in[5] * 0.125);
							out[2] = in[2];
							out[3] = (in[6] * 0.75) + (in[4] * 0.125) + (in[5] * 0.125);
						}
					},
...

					{
						...
						[](heph_audio_sample_t* in, heph_audio_sample_t* out) -> void
						{
							out[0] = (in[0] * 0.700) + (in[3] * 0.150) + (in[6] * 0.150);
							out[1] = (in[1] * 0.700) + (in[4] * 0.150) + (in[7] * 0.150);
							out[2] = in[2];
							out[3] = (in[5] * 0.75) + (in[3] * 0.125) + (in[4] * 0.125);
						}
					},
