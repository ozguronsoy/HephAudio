...
namespace HephAudio
{
	namespace FileFormats
	{
		...
		{
			RAISE_AND_THROW_HEPH_EXCEPTION(this, HephException(HEPH_EC_NOT_IMPLEMENTED, "Mp3Format::ReadFile", "Currently not supported due to the bugs in the FFmpegAudioDecoder class."));
			this->ffmpegAudioDecoder.ChangeFile(audioFile.FilePath());
