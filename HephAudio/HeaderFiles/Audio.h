...
namespace HephAudio
{
	...
	public:
		/** @copydoc HephAudio::Native::NativeAudio::OnAudioDeviceAdded */
		Heph::Event& OnAudioDeviceAdded;

		/** @copydoc HephAudio::Native::NativeAudio::OnAudioDeviceRemoved */
		Heph::Event& OnAudioDeviceRemoved;

		/** @copydoc HephAudio::Native::NativeAudio::OnCapture */
	...
	private:
		static std::shared_ptr<Native::NativeAudio> CreateNativeAudio(AudioAPI api);
	};
}