...
- More file format and codec support via [FFmpeg](https://ffmpeg.org/). You will need to enable this feature, and download an FFmpeg build. See [EnableFFmpeg](/docs/tutorials/EnableFFmpeg) for more information.

# Setup
### Visual Studio
1) Copy the HephAudio, HephCommon, and pocketfft folders to your projects root folder.
...
### Android Studio
1) Copy the HephAudio, HephCommon, and pocketfft folders to the same folder as your **CMAKE** file is in.
