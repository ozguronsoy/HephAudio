...
namespace HephCommon
{
	...
	public:
		...
		~ComplexBuffer();
		Complex& operator[](const size_t& frameIndex) const noexcept;
		...
		ComplexBuffer operator/(const Complex& rhs) const noexcept;
		ComplexBuffer& operator/=(const Complex& rhs) noexcept;
		ComplexBuffer operator*(const heph_float& rhs) const noexcept;
		ComplexBuffer& operator*=(const heph_float& rhs) noexcept;
		ComplexBuffer operator/(const heph_float& rhs) const noexcept;
		ComplexBuffer& operator/=(const heph_float& rhs) noexcept;
		ComplexBuffer operator<<(const size_t& rhs) const noexcept;
		ComplexBuffer& operator<<=(const size_t& rhs) noexcept;
		ComplexBuffer operator>>(const size_t& rhs) const noexcept;
		ComplexBuffer& operator>>=(const size_t& rhs) noexcept;
